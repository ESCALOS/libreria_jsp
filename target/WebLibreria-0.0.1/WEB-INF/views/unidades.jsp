...
<c:set var="titulo" value="Lista de Unidades de Medida" />

<c:set var="cabecera" >
    <div class="row m-2">
        <div class="col-9"><h1>Gestión de unidades de medida</h1></div>
...
<c:set var="cuerpoTabla">
    <c:forEach items="${data}" var="unidad">
        <tr>
            <td class="id">${unidad.getId()}</td>
            <td class="nombre">${unidad.getNombre()}</td>
            <td>
